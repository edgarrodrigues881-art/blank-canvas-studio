          ...
          return (
            <>
              ...
              {visible.map((msg, vi) => {
                ...
                return (
                  <div key={msg.id} id={`msg-${msg.id}`} className={cn("transition-all duration-500 ease-out", !showDate && prevMsg && (directionChanged ? "mt-8" : "mt-3"), highlightedMsgId === msg.id && "quoted-highlight rounded-xl")}>
                    {showDate && (
