      ...
      <SidebarGroup className="!p-0 !pt-1 px-2">
        ...
        <SidebarGroupContent>
          <SidebarMenu className={cn("space-y-[2px]", collapsed ? "px-0 flex flex-col items-center" : "px-2.5")}>
            {!(planPermBlocked && permissionMode === "hide") && (
            ...
            <SidebarGroup className="!p-0 !pt-1 px-2">
              ...
              <SidebarGroupContent>
                <SidebarMenu className={cn("space-y-[1px]", collapsed ? "px-0 flex flex-col items-center" : "px-2.5")}>
                  ...
                  {renderNavItem({ title: "Agendamento de Grupo", url: "/dashboard/group-crm/schedule", icon: CalendarClock })}
                </SidebarMenu>
              </SidebarGroupContent>
            </SidebarGroup>
            ...
            <SidebarGroup className="!p-0 !pt-1 px-2">
              ...
              <SidebarGroupContent>
                <SidebarMenu className={cn("space-y-[1px]", collapsed ? "px-0 flex flex-col items-center" : "px-2.5")}>
                  ...
                  {renderNavItem({ title: "Disparos Agendados", url: "/dashboard/crm-agendamentos", icon: CalendarClock })}
                </SidebarMenu>
              </SidebarGroupContent>
            </SidebarGroup>
            ...
            <SidebarGroup className="!p-0 !pt-1 px-2">
              ...
              <SidebarGroupContent>
                <SidebarMenu className={cn("space-y-[1px]", collapsed ? "px-0 flex flex-col items-center" : "px-2.5")}>
                  ...
                  {renderNavItem({ title: "Notificações", url: "/dashboard/ai-alerts", icon: BellRing })}
