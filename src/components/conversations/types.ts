...
export const mockMessages: Record<string, Message[]> = {
  "1": [
    ...
    { id: "m5", conversationId: "1", content: "Vocês têm teste grátis?", type: "received", timestamp: new Date(Date.now() - 1000 * 60 * 5).toISOString() },
    { id: "m6", conversationId: "1", content: "Olá, gostaria de saber mais sobre o plano Pro", type: "received", timestamp: new Date(Date.now() - 1000 * 60 * 2).toISOString() },
  ],
  "2": [
    { id: "m7", conversationId: "2", content: "Oi, preciso de ajuda com minha conta", type: "received", timestamp: new Date(Date.now() - 1000 * 60 * 60).toISOString() },
    { id: "m8", conversationId: "2", content: "Claro! O que está acontecendo?", type: "sent", timestamp: new Date(Date.now() - 1000 * 60 * 55).toISOString(), status: "read" },
    { id: "m9", conversationId: "2", content: "Já resolvi, era só atualizar a página", type: "received", timestamp: new Date(Date.now() - 1000 * 60 * 20).toISOString() },
    { id: "m10", conversationId: "2", content: "Obrigada pelo atendimento!", type: "received", timestamp: new Date(Date.now() - 1000 * 60 * 15).toISOString() },
  ],
  "3": [
    { id: "m11", conversationId: "3", content: "Quando vocês vão liberar a nova funcionalidade?", type: "received", timestamp: new Date(Date.now() - 1000 * 60 * 45).toISOString() },
  ],
  "5": [
    { id: "m12", conversationId: "5", content: "Oi, preciso de ajuda com a configuração do proxy", type: "received", timestamp: new Date(Date.now() - 1000 * 60 * 60 * 5).toISOString() },
    { id: "m13", conversationId: "5", content: "Preciso de ajuda com a configuração", type: "received", timestamp: new Date(Date.now() - 1000 * 60 * 60 * 5).toISOString() },
  ],
};
