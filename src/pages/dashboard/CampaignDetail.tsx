...
import {
  ...
  Search, Timer, Hash, Zap, RefreshCw, RotateCcw, Send, Ban, ChevronDown, Download, ShieldAlert, Save, Loader2, Users, Trash2,
} from "lucide-react";
    ...
    if (isCarousel) {
      ...
      const onSuccess = () => {
        toast({
          ...
          description: `"${normalizedName}" ${existingTemplate ? "atualizado" : "salvo"} em Template Carrossel.`,
        });
        setSaveTemplateOpen(false);
        setSaveTemplateName("");
      };
      const onError = (err: any) => toast({ title: "Erro", description: err.message, variant: "destructive" });
