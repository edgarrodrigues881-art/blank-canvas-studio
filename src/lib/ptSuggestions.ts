...
const VOCAB = [
  "olá", "oi", "tudo bem", "bom dia", "boa tarde", "boa noite",
  "obrigado", "obrigada", "por favor", "desculpa", "desculpe",
  "pessoa", "pessoal", "pessoas", "pessoalmente",
  "produto", "produtos", "preço", "promoção", "pagamento",
  "pedido", "pedidos", "pendente", "pendência",
  "entrega", "entregue", "entregar", "endereço", "envio", "enviar",
  "informação", "informações", "interessado", "interessada",
  "atendimento", "atender", "atendente",
  "agradeço", "aguardo", "aguardando", "anexo", "anexei",
  "mensagem", "mensagens", "momento", "minuto", "minutos",
  "número", "necessário", "necessita",
  "cliente", "clientes", "contato", "contatos", "confirmar", "confirmado", "cadastro",
  "valor", "valores", "vendas", "vender", "verifico", "verificar", "verificando",
  "disponível", "disponibilidade", "data", "dia", "dias",
  "empresa", "equipe", "encaminhar", "encaminhei",
  "ficar", "ficou", "ficaria", "favor",
  "gostaria", "garantia", "ganhou",
  "horário", "hora", "horas",
  "ajudar", "ajuda", "amanhã", "agora",
  "qualquer", "quando", "quanto", "quantidade", "questão",
  "retorno", "retornar", "responder", "resposta", "recebido", "recebi",
  "solicitação", "solicitar", "segue", "semana",
  "tudo", "também", "talvez", "tarde", "tipo",
  "você", "vocês", "vamos", "verdade",
  "perfeito", "perfeita", "ótimo", "ótima",
  "claro", "combinado", "certo", "certeza",
