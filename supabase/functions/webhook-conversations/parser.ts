...
export function extractConversationEvent(body: JsonObject): ParsedConversationEvent | null {
  ...
  const content = firstString(
    ...
    body.data?.message?.content?.selectedDisplayText,
    ...messageNodes.flatMap((node) => [
      node.conversation,
      node.text,
      node.body,
      ...
      node.content?.text || "",
      node.content?.selectedDisplayText,
      node.content?.selectedText,
      node.content?.vote,
  ...
  const buttonResponseId = firstString(
    ...
    ...messageNodes.flatMap((node) => [
      ...
      node.content?.selectedButtonId,
      node.content?.selectedID,
      node.content?.selectedId,
      node.content?.buttonOrListid,
      node.content?.buttonOrListId,
    ]),
    ...
    body.data?.buttonId,
    body.data?.button_id,
    body.data?.buttonOrListid,
    body.data?.buttonOrListId,
    body.data?.selectedID,
    body.data?.selectedId,
    body.message?.selectedButtonId,
    body.message?.selectedID,
    body.message?.selectedId,
    body.message?.buttonId,
    body.message?.buttonOrListid,
    body.message?.buttonOrListId,
    body.message?.content?.selectedButtonId,
    body.message?.content?.selectedID,
    body.message?.content?.selectedId,
    body.message?.content?.buttonOrListid,
    body.message?.content?.buttonOrListId,
    body.data?.message?.content?.selectedButtonId,
    body.data?.message?.content?.selectedID,
    body.data?.message?.content?.selectedId,
