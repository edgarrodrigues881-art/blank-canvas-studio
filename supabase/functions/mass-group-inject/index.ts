...
const API_TIMEOUT_MS = 45_000; // Increased to 45s to avoid timeout on 5th contact
const DISCONNECT_RECHECK_COUNT = 3; // 3 checks for better stability
const DISCONNECT_RECHECK_INTERVAL_MS = 5_000; // 5s between checks
