-- Migrate warmup_folders from legacy user to current user where applicable
-- Also add warmup_folders and warmup_folder_devices to the handle_new_user trigger migration
...
BEGIN
  ...
  IF _existing_profile_id IS NOT NULL THEN
    ...
    -- Migrate warmup folders and folder devices
...
-- Migrate existing legacy folders to current user
UPDATE public.warmup_folders 
SET user_id = 'f5220141-3b20-4e85-90fd-8c85695686fa' 
WHERE user_id = 'c9a939dc-6ca8-44f9-9da8-dc06f044c8c5';

UPDATE public.warmup_folder_devices 
SET user_id = 'f5220141-3b20-4e85-90fd-8c85695686fa' 
WHERE user_id = 'c9a939dc-6ca8-44f9-9da8-dc06f044c8c5';